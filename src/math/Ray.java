...
//	public Ray transform(Transformation tf){
//		return new Ray(tf.transform(origin), tf.transform(direction));
//	}
//	
//	public Ray invTransform(Transformation tf){
//		return new Ray(tf.transformInverse(origin), tf.transformInverse(direction));
//	}
}
